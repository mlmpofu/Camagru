...
if (isset($_POST['register']))
{
    ...
    else
    {
        ...
        $sql = "INSERT INTO  CAMAGRU.users (username, email, pass, vkey) VALUES (?, ?, ?, ?)";
        $stmt= $conn->prepare($sql);
        $stmt->bindParam(1, $username);
        $stmt->bindParam(2, $email);
    ...
    // the message
 $msg = "Thank you for registering.\nClick on the link below to proceed<br><br>
        http://localhost:8081/Camagru/Controllers/verifyemail.php?vkey=$vkey";
